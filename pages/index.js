    ...
    <div className={styles.parallax}>
      <div className={props.theme ? styles.container_light : styles.container}>
        <Head>
          ...
          <meta name="description" content="Official Infinity Coders Club Website" />
          ...
          >
            ...
            <p>
              ...
              The club's motto is to create, build and Innovate, the vision of this club is not only restricted to coding but we also encourage students to take part in various activities such as national level hackathons and other related events.
               R1 Infinity Coders Club is financially supported by AICTE-
              SPICES (Scheme for Promoting Interests Creativity and Ethies among Students)
              <br />
            ...
            >
              <a href="3333333333333333333333333333333333333333" target="_blank">
                Join Us
              </a>
            </Button>
          </div>
          ...
          <div className={styles.gradientDiv}>
            <div className={styles.opensourceDiv}>
              ...
              <button
                ...
                onClick={() => {
                  location.href = "https://333333333333333333";
                }}
              >
                Check it out
              </button>
          ...
          <Container fluid>
            <Row className={styles.tileRow}>
              <Col xs="12" sm="6" md="3" className={styles.tileContainer}>
                <Tile tileColor="blueBG" tileImage="cc.png" />
              </Col>
              <Col xs="12" sm="6" md="3" className={styles.tileContainer}>
        <Tile tileColor="greenBG" tileImage="id.png" />
      </Col>
      <Col xs="12" sm="6" md="3" className={styles.tileContainer}>
        <Tile tileColor="redBG" tileImage="py.png" />
      </Col>
      <Col xs="12" sm="6" md="3" className={styles.tileContainer}>
        <Tile tileColor="yellowBG" tileImage="apt.png" />
      </Col>
            </Row>
          </Container>
        </div>
