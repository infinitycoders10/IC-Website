    ...
    <>
      <div className={props.theme ? styles.container_light : styles.container}>
        <Head>
          ...
          <meta name="description" content="Official Infinity Coders Website" />
        ...
        <div className={props.theme ? styles.dropdownContainer_light : styles.dropdownContainer}>
          ...
          >
            ...
            <Dropdown.Menu style={{ "background-color": "#070707" }}>
              ...
              <Dropdown.Item>
                <button className={styles.filterButton} onClick={() => setfilter("TALKS")}>
                  TALKS
                </button>
              </Dropdown.Item>
              <Dropdown.Item>
                <button className={styles.filterButton} onClick={() => setfilter("IDEATHON")}>
                  IDEATHON
                </button>
              </Dropdown.Item>
              <Dropdown.Item>
                <button className={styles.filterButton} onClick={() => setfilter("HACKATHON")}>
                  HACKATHON
                </button>
              </Dropdown.Item>
            </Dropdown.Menu>
